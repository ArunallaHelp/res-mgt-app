...
Write-Host "  GA_MEASUREMENT_ID: $env:NEXT_PUBLIC_GA_MEASUREMENT_ID"
Write-Host ""
...
$NEXT_PUBLIC_WHATSAPP_SUPPORT_GROUP_URL = $env:NEXT_PUBLIC_WHATSAPP_SUPPORT_GROUP_URL

# Update the trigger with substitution variables
gcloud builds triggers update $TRIGGER_NAME `
    --region=$REGION `
    --update-substitutions="_NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL,_NEXT_PUBLIC_SUPABASE_ANON_KEY=$NEXT_PUBLIC_SUPABASE_ANON_KEY,_NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL=$NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL,_NEXT_PUBLIC_GA_MEASUREMENT_ID=$NEXT_PUBLIC_GA_MEASUREMENT_ID,_NEXT_PUBLIC_WHATSAPP_SUPPORT_GROUP_URL=$NEXT_PUBLIC_WHATSAPP_SUPPORT_GROUP_URL"
